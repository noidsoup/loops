---
name: loops-tdd
description: Test-driven development. Write a failing test that names the desired behavior, make it pass with the smallest change, then refactor under a green suite.
---
# tdd
