---
name: loops-dispatcher
description: Entry router / intent classifier. Reads user intent, classifies it against the available loops, and dispatches to the right one. Never executes a task directly — only routes.
---
# dispatcher
