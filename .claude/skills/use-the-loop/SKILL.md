---
name: use-the-loop
description: Meta conductor. Decision tree over loops that exist in this repo; may
---
# use-the-loop
...
3. **Load** `loops/<name>/loop.md` and follow it fully. Don't half-run.
4. **Gate** before chaining: only proceed if the prior loop's exit condition is met.
